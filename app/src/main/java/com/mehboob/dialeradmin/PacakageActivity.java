...
public class PacakageActivity extends AppCompatActivity implements CFCheckoutResponseCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnUpgrade.setVisibility(hasActivePlan && !isExpired ? View.VISIBLE : View.GONE);
        ...
        btnRestore.setOnClickListener(v -> {
            ...
            MyApplication.getInstance().loadAdminData(uid, new MyApplication.OnAdminLoadedListener() {
                @Override public void onAdminLoaded(com.mehboob.dialeradmin.models.AdminModel admin) {
    ...
    private void refreshCtas() {
        ...
        if (sameAsActive) {
            ...
            btnUpgrade.setVisibility(showUpgrade ? View.VISIBLE : View.GONE);
        }
    }
